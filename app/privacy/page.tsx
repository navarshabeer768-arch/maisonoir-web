  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2]">
      ...
      <div className="max-w-3xl mx-auto px-6 md:px-12 py-20">
        ...
        <h1 className="font-display text-5xl font-light text-[#2A2420] mb-10">Privacy Policy</h1>
        <div className="bg-white border border-[rgba(42,36,32,0.08)] p-10 shadow-sm space-y-6 text-[#6B5E4A] text-sm leading-relaxed">
          <p>We take your privacy seriously. We never sell your personal data. Information collected is used solely to process your orders and improve your experience.</p>
